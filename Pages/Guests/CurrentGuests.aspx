<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CurrentGuests.aspx.cs" Inherits="HotelManagement.CurrentGuests" %>
    ...
    <form id="form1" runat="server">
        <div class="header">
            <div class="header-content">
                <h1><i class="fas fa-users"></i> Current Guests</h1>
        ...
        <div class="container">
            <div class="page-intro">
                <h2>Manage Current Guests</h2>
                <p>View and manage guests currently staying at the hotel</p>
            </div>
            ...
            <div class="stats-cards">
                ...
                <div class="stat-card">
                    <div class="stat-label">Expected Checkouts</div>
                    <div class="stat-value">
                        <asp:Label ID="lblExpectedCheckouts" runat="server" Text="0"></asp:Label>
                    </div>
                </div>
            </div>
            ...
            <div class="guests-grid">
                <div class="grid-header">
                    <h3><i class="fas fa-bed"></i> Current Guests</h3>
                </div>
                <div class="gridview-wrapper">
                    <asp:GridView ID="gvCurrentGuests" runat="server" 
                        CssClass="gridview" 
                        AutoGenerateColumns="False"
                        OnRowCommand="gvCurrentGuests_RowCommand"
                        EmptyDataText="No current guests">
                        <Columns>
                            ...
                            <asp:BoundField DataField="AmountPaid" HeaderText="Paid" DataFormatString="¥{0:N0}" />
                            <asp:TemplateField HeaderText="Balance">
                                <ItemTemplate>
                                    ¥<%# String.Format("{0:N0}", Convert.ToDecimal(Eval("TotalAmount")) - Convert.ToDecimal(Eval("AmountPaid"))) %>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Actions">
                                <ItemTemplate>
                                    <asp:Button ID="btnCheckOut" runat="server" 
                                        ...
                                        OnClientClick="return confirm('Are you sure you want to check out this guest?');" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <EmptyDataTemplate>
                            <div class="empty-state">
                                ...
                                <div class="empty-title">No Current Guests</div>
                                <div class="empty-desc">All rooms are currently available</div>
                            </div>
                        </EmptyDataTemplate>
                    </asp:GridView>
                </div>
